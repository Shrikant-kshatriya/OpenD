...
```
dfx canister call opend_backend listItem '(principal "ahw5u-keaaa-aaaaa-qaaha-cai", 100)'
```
...
```
dfx canister call ahw5u-keaaa-aaaaa-qaaha-cai transferOwnership '(principal "be2us-64aaa-aaaaa-qaabq-cai")'
```
